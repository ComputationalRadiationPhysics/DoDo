...
//        >;
        ...
        // fully qualified name, separated by "."
        std::string fullName;
            ...
            fullName { fullName }
        {
            ...
            // MUST be prefixed with "cluster" to enable rendering of subgraphs
            boost::get_property(sg, boost::graph_name) = "cluster"+name;
            boost::get_property(sg, boost::graph_graph_attribute)["label"] = name;
        }
