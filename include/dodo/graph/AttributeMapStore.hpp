...
namespace dodo
{
    namespace graph
    {
        ...
        public:
            ...
            enum
            {
                AttributeCount = std::tuple_size<AttributeTypesTuple>::value
            };
...
//private:
        ...
        template<typename... AttributeTypes>
        auto
        AttributeMapStore<AttributeTypes...>::placeCopy(
            MapID mapID,
            boost::variant<AttributeTypes...> entry
        )
        ...
        public:
            ...
            explicit AttributeHandle(
                MapID pMapID,
                EntryID pEntryID,
                std::weak_ptr<StoreType> p,
                HiddenType
            )
                :
                mapID(pMapID),
